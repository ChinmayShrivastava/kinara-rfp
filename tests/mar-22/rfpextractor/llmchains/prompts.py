...
RFP_INFO_PROMPT = (
    "Attached is a text from an RFP document.\n"
    "Based on the given schema, if the information isn't already extracted and stored, extract all that you can.\n"
    "The schema is as follows:\n"
    "{schema}\n"
    "The text is as follows:\n"
    "{text}"
...
ELIGIBILITY_PROMPT = (
    ...
    "Extract all the eligibility criteria as a list from the following text, don't repeat, and be exhaustive. An eligibility criterion is a"
    "requirement that can fit into the sentence, \"The applicant must be...\": \n\n"
    "{text}"
)

SUBMISSION_PROMPT = (
    "Attached is a text from an RFP document, suspected to contain submission information.\n"
    "Extract all the submission information as a list from the following text, don't repeat, and be exhaustive. A submission requirement is a"
    "requirement that can fit into the sentence, \"The applicant must submit...\": \n\n"
    "{text}"
)